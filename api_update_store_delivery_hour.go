...
func (r ApiUpdateStoreDeliveryHourRequest) Authorization(authorization string) ApiUpdateStoreDeliveryHourRequest {
...
func (r ApiUpdateStoreDeliveryHourRequest) UpdateDeliveryHourRequest(updateDeliveryHourRequest UpdateDeliveryHourRequest) ApiUpdateStoreDeliveryHourRequest {
	r.updateDeliveryHourRequest = &updateDeliveryHourRequest
	return r
}

func (r ApiUpdateStoreDeliveryHourRequest) Execute() (*UpdateDeliveryHourResponse, *http.Response, error) {
	return r.ApiService.UpdateStoreDeliveryHourExecute(r)
}
...
*/
func (a *UpdateStoreDeliveryHourAPIService) UpdateStoreDeliveryHour(ctx context.Context, merchantID string) ApiUpdateStoreDeliveryHourRequest {
	return ApiUpdateStoreDeliveryHourRequest{
		ApiService: a,
		ctx: ctx,
...
func (a *UpdateStoreDeliveryHourAPIService) UpdateStoreDeliveryHourExecute(r ApiUpdateStoreDeliveryHourRequest) (*UpdateDeliveryHourResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *UpdateDeliveryHourResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UpdateStoreDeliveryHourAPIService.UpdateStoreDeliveryHour")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/partner/v1/merchants/{merchantID}/store/opening-hours"
	...
	if r.updateDeliveryHourRequest == nil {
		return localVarReturnValue, nil, reportError("updateDeliveryHourRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateDeliveryHourRequest
