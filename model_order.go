...
// Order A JSON object containing the order information. This is only applicable for STO order in Push Order State Webhook 
type Order struct {
...
func (o *Order) SetOrderReadyEstimationNil() {
