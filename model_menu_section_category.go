...
// checks if the MenuSectionCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MenuSectionCategory{}
...
type _MenuSectionCategory MenuSectionCategory
...
func (o *MenuSectionCategory) GetItems() []MenuSectionCategoryItem {
	if o == nil {
		var ret []MenuSectionCategoryItem
		return ret
	}
...
func (o *MenuSectionCategory) UnmarshalJSON(data []byte) (err error) {
	...
	varMenuSectionCategory := _MenuSectionCategory{}

	err = json.Unmarshal(data, &varMenuSectionCategory)

	if err != nil {
		return err
	}

	*o = MenuSectionCategory(varMenuSectionCategory)
...
type NullableMenuSectionCategory struct {
	value *MenuSectionCategory
	isSet bool
}

func (v NullableMenuSectionCategory) Get() *MenuSectionCategory {
	return v.value
}

func (v *NullableMenuSectionCategory) Set(val *MenuSectionCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableMenuSectionCategory) IsSet() bool {
	return v.isSet
}
...
func NewNullableMenuSectionCategory(val *MenuSectionCategory) *NullableMenuSectionCategory {
	return &NullableMenuSectionCategory{value: val, isSet: true}
}
